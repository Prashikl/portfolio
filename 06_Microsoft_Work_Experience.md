...
- **Design Walkthrough (Owned):**
  MSEDS Orders Customer self serve -- Design walkthrough (mp4)

### Connected Program Artefacts (Ordering ecosystem)

- **eMSL Retirement -> VL Central (spec):**
  eMSL Build in VLC (docx)

- **Parity / Parity++ mapping (where Orders choices were tracked):**
  eMSL Build in VLC Feature (xlsx)

### Local References (add these PDFs into the same folder as this .md)
...
- Trust in pricing, eligibility, and quote artefacts
- Compliance and auditability
- High throughput (bulk orders, large orders, complex scenarios)
- Minimal operational touch and fewer escalations
- A platform foundation that supports retirement of legacy tools (POET/VLCT)
...
- End-to-end ordering experience design (Phase 1 -> Phase 2 and onwards)
